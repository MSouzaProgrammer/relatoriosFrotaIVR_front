...
function Abastecimento() {
  ...
  const [
    ...
    setAbastecimentoEditando,
  ] = useState<Abastecimento | null>(
    null
  );
  ...
  const totalLitrosPagina =
    registrosExibidos.reduce(
      (total, registro) =>
        total +
        Number(
          registro.quantLitro || 0
        ),
      0
    );
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="min-w-0">
          ...
          <p className="text-slate-600 text-sm font-light mt-1">
            Controle os abastecimentos realizados pela frota.
          </p>
